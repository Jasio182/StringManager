...
namespace StringManager.Services.Tests.APITests.ValidatorsTests
{
    public class AddUserRequestValidatorTests
    {
        ...
        public void AddUserRequestValidator_ShouldNotHaveAnyErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
        ...
        public void AddUserRequestValidator_ShouldHaveDailyMaintananceErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHaveAccountTypeToAddErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHaveEmailErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHavePasswordErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHavePlayStyleErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHaveUsernameErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHaveAccountTypeErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
        ...
        public void AddUserRequestValidator_ShouldHaveUserIdErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance dailyMaintenance, Core.Enums.AccountType accountTypeToAdd,
            string email, string password, Core.Enums.PlayStyle playStyle, string username)
        {
            var testUserRequest = new AddUserRequest()
            {
