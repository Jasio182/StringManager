...
namespace StringManager.Services.Tests.APITests.ValidatorsTests
{
    internal class ModifyUserRequestValidatorTests
    {
        ...
        public void ShouldNotHaveAnyErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
        ...
        public void ShouldHaveDailyMaintananceErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
            string email, string password, Core.Enums.PlayStyle? playStyle, string username, int id)
        {
            var testUserRequest = new ModifyUserRequest()
            {
        ...
        public void ShouldHaveAccountTypeToUpdateErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
            string email, string password, Core.Enums.PlayStyle? playStyle, string username, int id)
        {
            var testUserRequest = new ModifyUserRequest()
            {
        ...
        public void ShouldHavePlayStyleErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
            string email, string password, Core.Enums.PlayStyle? playStyle, string username, int id)
        {
            var testUserRequest = new ModifyUserRequest()
            {
        ...
        [TestCase((Core.Enums.AccountType)0, 3, Core.Enums.GuitarDailyMaintanance.CleanHandsWipedStrings, Core.Enums.AccountType.User, "testEmail3", "testPassword3", Core.Enums.PlayStyle.Light, "testUsername3", -3)]
        public void ShouldHaveIdErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
            string email, string password, Core.Enums.PlayStyle? playStyle, string username, int id)
        {
            var testUserRequest = new ModifyUserRequest()
            {
    ...
    [Test]
        ...
        public void ShouldHaveAccountTypeErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
            string email, string password, Core.Enums.PlayStyle? playStyle, string username, int id)
        {
            var testUserRequest = new ModifyUserRequest()
            {
        ...
        public void ShouldHaveUserIdErrors(Core.Enums.AccountType? accountType, int? userId, Core.Enums.GuitarDailyMaintanance? dailyMaintenance, Core.Enums.AccountType? accountTypeToUpdate,
            string email, string password, Core.Enums.PlayStyle? playStyle, string username, int id)
        {
            var testUserRequest = new ModifyUserRequest()
            {
